...
#define FL_SFT  LM(_FL, MOD_LSFT)
#define FL_ALT  LM(_FL, MOD_LALT)
#define FL_SALT LM(_FL, MOD_LSFT | MOD_LALT)
...
[_BL] = KEYMAP_ANSI(
  ...
  MO(_FL),KC_LALT,KC_LGUI,                KC_SPC,                                 KC_RGUI,FL_SALT,FL_SFT, FL_ALT),
